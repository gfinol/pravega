...
class SegmentInputStreamImpl implements SegmentInputStream {
    static final int MIN_BUFFER_SIZE = 1024 * 1024;
    static final int DEFAULT_BUFFER_SIZE = 8 * 1024 * 1024;
    static final int MAX_BUFFER_SIZE = 20 * 1024 * 1024;
    private static final int DEFAULT_READ_LENGTH = 2 * 1024 * 1024;
