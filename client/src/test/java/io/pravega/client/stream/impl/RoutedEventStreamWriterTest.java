...
public class RoutedEventStreamWriterTest extends LeakDetectorTestSuite {
    @Test
    public void testWrite() {
        ...
        EventStreamWriter<String> writer = new RoutedEventStreamWriterImpl<>(stream, "id", controller, streamFactory,
                new JavaSerializer<>(), config, executorService(), executorService(), null, (rk)->0.1);
    ...
    public void testEndOfSegment() {
        ...
        @Cleanup
        EventStreamWriter<String> writer = new RoutedEventStreamWriterImpl<>(stream, "id", controller, streamFactory, serializer,
                config, executorService(), executorService(), null, (rk)->0.1);
    ...
    public void testAutoNoteTime() {
        ...
        @Cleanup
        EventStreamWriter<String> writer = new RoutedEventStreamWriterImpl<>(stream, "id", controller, streamFactory, serializer,
                config, executor, executor, null, (rk)->0.1);
